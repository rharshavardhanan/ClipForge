...
import { MontageTab } from '@/components/montage-tab';
...
const NAV = [
  ...
  { id: 'Montage', label: 'Montage', sub: 'Video + music → beat-synced montagem edit', icon: 'rank' },
    ...
    <Tabs.Root value={tab} onValueChange={setTab} orientation="vertical" className="flex min-h-screen">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="mx-auto w-full max-w-5xl flex-1 px-8 py-8">
          ...
          <Tabs.Content value="Montage" forceMount className="animate-fade-up outline-none data-[state=inactive]:hidden"><MontageTab /></Tabs.Content>
